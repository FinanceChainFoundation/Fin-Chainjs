...
export const lock_balance_operation_fee_parameters = new Serializer(
    "lock_balance_operation_fee_parameters",
    {fee: uint64,
        price_per_kbyte: uint32}
);

export const set_lock_data_operation_fee_parameters = new Serializer(
    "set_lock_data_operation_fee_parameters",
    {fee: uint64,
        price_per_kbyte: uint32}
);

export const unlock_balance_operation_fee_parameters = new Serializer(
    "unlock_balance_operation_fee_parameters",
    {fee: uint64,
        price_per_kbyte: uint32}
);

export const donation_balance_operation_fee_parameters = new Serializer(
    "donation_balance_operation_fee_parameters",
    {fee: uint64,
        price_per_kbyte: uint32}
);
export const asset_presale_create_operation_fee_parameters = new Serializer(
    "asset_presale_create_operation_fee_parameters",
    {fee: uint64,
        price_per_kbyte: uint32}
);
export const asset_presale_buy_operation_fee_parameters = new Serializer(
    "asset_presale_buy_operation_fee_parameters",
    {fee: uint64}
);
export const asset_presale_claim_operation_fee_parameters = new Serializer(
    "asset_presale_claim_operation_fee_parameters",
    {fee: uint64}
);
...
export const unlock_detail = new Serializer(
    "unlock_detail",
    {   asset_id: protocol_id_type("locked_balance"),
        expired: bool
    }
);
...
export const support_asset=new Serializer(
    "support_asset",
    {   asset_id: protocol_id_type("asset"),
        amount: int64,
        base_price: price,
...
export const early_bird_pecent = new Serializer(
    "early_bird_pecent",
    {time: time_point_sec,
    percent: uint32}
);
...
export const op44 = new Serializer(
    "op44",
    { fee: asset,
        issuer: protocol_id_type("account")}
);

export const lock_balance = new Serializer(
    "lock_balance",
    { fee: asset,
        issuer: protocol_id_type("account"),
        amount: asset,
...
export const set_lock_data = new Serializer(
    "set_lock_data",
    { fee: asset,
        issuer: protocol_id_type("account"),
...
export const unlock_balance = new Serializer(
    "unlock_balance",
    { fee: asset,
        issuer: protocol_id_type("account"),
...
export const donation_balance = new Serializer(
    "donation_balance",
    { fee: asset,
        issuer: protocol_id_type("account"),
        amount: asset,
...
export const asset_presale_create = new Serializer(
    "asset_presale_create",
    { fee: asset,
        issuer: protocol_id_type("account"),
        title: string,
        description: string,
...
export const asset_presale_buy = new Serializer(
    "asset_presale_buy",
    { fee: asset,
        issuer: protocol_id_type("account"),
...
export const asset_presale_claim = new Serializer(
    "asset_presale_claim",
    { fee: asset,
        issuer: protocol_id_type("account"),
        presale: protocol_id_type("asset_presale"),
