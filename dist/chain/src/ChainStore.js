...
var ChainStore = function () {
    ...
    */
    ...
    ChainStore.prototype.fetchFullAccount = function fetchFullAccount(name_or_id) {
        ...
        if (_ChainValidation2.default.is_object_id(name_or_id) && !subChanged) {
        ...
        if (subChanged || !this.fetching_get_full_accounts.has(name_or_id) || Date.now() - this.fetching_get_full_accounts.get(name_or_id) > 5000) {
            ...
            _bitsharesjsWs.Apis.instance().db_api().exec("get_full_accounts", [[name_or_id], autosubscribe]).then(function (results) {
                ...
                account.fix_balances = new _immutable2.default.Map();
                ...
                */
                ...
                console.log("Error: ", error);
                if (_ChainValidation2.default.is_object_id(name_or_id)) _this10.objects_by_id.delete(name_or_id);else _this10.accounts_by_name.delete(name_or_id);
            });
        }
        return undefined;
    };
    ...
    */
    ...
    ChainStore.prototype.fetchRecentHistory = function fetchRecentHistory(account) {
        ...
        pending_request.promise = new Promise(function (resolve, reject) {
            _bitsharesjsWs.Apis.instance().history_api().exec("get_account_history", [account_id, stop, limit, most_recent]).then(function (operations) {
        ...
        */
        ...
        if (object.id.substring(0, balance_prefix.length) == balance_prefix) {
            ...
            if (_owner === undefined || _owner === null) {
                ...
                if (!fix_balances) {
                    _owner = _owner.set("fix_balances", _immutable2.default.Map());
            ...
            var self = this;
            _bitsharesjsWs.Apis.instance().db_api().exec("get_asset_presales", [object.id]).then(function (presales_object) {
